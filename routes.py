...
from controllers.feedback_controller import submit_feedback, get_feedback, delete_feedback, get_rating_summary
...
api.route("/feedback/summary", methods=["GET"])(get_rating_summary)
